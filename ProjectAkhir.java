...
public class ProjectAkhir {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("2.Setting Diskon");
            ...
            switch (menu) {
                ...
                case 3:
                    ...
                    hasilDiskon = totalHarga * upDiskon ;
                    totalHarga = totalHarga-hasilDiskon; 
                    double finalHarga = totalHarga - diskon;
                    ...
                    dataPenjualan[jumlahTransaksi][6] = Double.toString(finalHarga);
